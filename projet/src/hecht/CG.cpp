...
template double * myscopy<unsigned long long,double>(unsigned long long n,const double *x,double *y);
template double * myscal<unsigned long long,double>(unsigned long long n,double  a,double *x);
